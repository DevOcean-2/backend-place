...
2. 패키지 설치
   ...
   ```
3. 로컬 개발 시 DB 설정
   aws IAM AmazonOpenSearchServiceFullAccess 추가, 키 발급
   ./app/database 폴더에 .env 파일 추가
   ```
   OPENSEARCH_URL=https://search-balm-opensearch-bmxhjzbqqqcxean7t7oqwv4dwe.ap-northeast-2.es.amazonaws.com
   AWS_ACCESS_KEY_ID=
